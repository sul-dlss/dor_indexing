...
class DorIndexing
  module Builders
    ...
    class DocumentBuilder
      ...
      def initialize(model:, workflow_client:, cocina_repository:, administrative_tags_repository:, release_tags_repository:)
        @model = model
        @workflow_client = workflow_client
        @cocina_repository = cocina_repository
        @administrative_tags_repository = administrative_tags_repository
        @release_tags_repository = release_tags_repository
      end
      ...
      attr_reader :model, :workflow_client, :cocina_repository, :administrative_tags_repository, :release_tags_repository
      ...
      def parent_collections
        ...
        Array(model.structural&.isMemberOf).filter_map do |rel_druid|
          @@parent_collections[rel_druid] ||= cocina_repository.call(rel_druid)
      ...
      def administrative_tags
        administrative_tags_repository.call(id)
      rescue DorIndexing::RepositoryError
        []
      end
    end
