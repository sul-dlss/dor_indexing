...
Gem::Specification.new do |spec|
  ...
  # spec.add_dependency 'cocina-models', git: 'https://github.com/sul-dlss/cocina-models.git', branch: 'title-build-tweaks'
  # spec.add_dependency 'dor-workflow-client', '~> 7.0' # this should live here after cocina-models is released
